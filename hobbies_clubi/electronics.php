...
<body>
    <div id="heads"><img src="images/hc1.png" style="position :absolute; top:50px;left:34%;"/>
        ...
        <ul class="nav"><li ><a  href="index.php" id="home" class="anchorLink">Hobbies club</a></li><li><a id="webd" class="anchorLink" href="webd.php">Web D</a></li>
            ...
            <li class = "active"><a id="team" href="electronics.php" class="anchorLink">Electronics</a></li>
...
<p style="margin-left:10px;color: #222;font-size: 26px;font-weight: 400;">About Electronics Club</p><hr class ="line"><p class="para">
In this modern world we can not imagine a life without electronic gadgets.
            
            Electronics section guides the young and imaginative brains through the fascinating world of electronics, it caters to their needs. 
            It provides a platform for the burgeoning minds of the institute, to  spot the talent in them and exploit it for the betterment of the country. 
            The Section provides every bit of assistance it can, to help the students in developing the circuit as well as in troubleshooting.
...
<p class ="para">Secretary : Shiva teja </p>
...
<?php 
                    ...
                    $note=mysql_query("SELECT * FROM notices WHERE designation ='Electronics Club Secretary'ORDER BY expiry DESC");
