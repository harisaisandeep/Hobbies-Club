...
public function uploadFile($file_name , $temp_name, $path,$error){
$filename = $file_name;
			...
			else
			{
				...
				{
					@move_uploaded_file($temp_name,$path."/".$filename);
					$select = mysql_query("INSERT INTO events (filePath, fileName) VALUE('$path', '$filename')");
				}
			}
