...
<body>
    <div id="heads"><img src="images/hc1.png" style="position :absolute; top:50px;left:34%;"/>
        ...
        <div>
        <ul class="nav">            <li ><a  href="index.php" id="home" class="anchorLink">Hobbies club</a></li>
<li class = "active"><a id="webd" href="webd.php" class="anchorLink">Web D</a></li>
...
<p style="margin-left:10px;color: #222;font-size: 26px;font-weight: 400;">About Web Designing Club</p><hr class ="line"><p class="para">Web Designing & Software Development is the newest jewel added in the crown of Hobbies Club.<br/>
            
             In this section students can utilize their time and facilities, to learn and to do innovative work.
                 Time to time, <br/>lectures on different programming languages (for example C++, Javascript, Java) and workshops on
                  various application software (for example Visual basic, flash, dream weaver, Photoshop, Matlab etc.) 
                  are organized.<br/>Students are also developing commercial websites & applications for various the campus. They have zeal to<br/> develop innovative applications.<br/>
                 The section has a long list of achievements and we are hoping much more for the future.</p>

<p style="margin-left:10px;color: #222;font-size: 26px;font-weight: 400;">Our Mission</p><hr class ="line">
<p class="para">Our mission is to provide a platform for the young budding engineers to acquire and further enrich their <br/>designing and programming skills.</p>

<p style="margin-left:10px;color: #222;font-size: 26px;font-weight: 400;">Contact Info</p><hr class ="line">
<p class ="para">Secretary : Hari sai sandeep </p>
...
<?php 
                    ...
                    $note=mysql_query("SELECT * FROM notices WHERE designation ='Web Designing Club Secretary' ORDER BY expiry DESC");
