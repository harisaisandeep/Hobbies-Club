...
<body>
    <div id="heads"><img src="images/hc1.png" style="position :absolute; top:50px;left:34%;"/>
        ...
        <ul class="nav">
            ...
            <li><a id="webd" class="anchorLink" href="webd.php">Web D</a></li>
            ...
            <li class = "active"><a id="contact" href="contact.php" class="anchorLink">Contact Us</a></li>
        </ul>
    </div>
</div>
...
<div>
<div id="details">
<a href="#"><div class="mini" id="about">CONTACT US</div></a>
...
<div><!--news display-->
         <ul id="ticker">
            ...
            $new=strtotime ('-2 week' , strtotime($dat));
...
<div id="mainContent">
<div class="mainContent" id="aboutd"><br/>
<span style="margin-left:10px; color: #222;font-size: 24px;font-weight: 400;"><img src="images/leaf.png" width="67" height="65"/>Give us Feedback</span><img src="images/line.png" width="800px" height="5px;"/>
                    <form action="#" method="post">
            <table align="left" style="margin-top:40px; margin-left:50px;" width="400px">
                <tr><td>USERNAME</td><td align="right"><input type="text" name="usname" /></td></tr>
                <tr><td>SUBJECT </td><td align="right"><input type="text" name="sub" /></td></tr>
                <tr><td>EMAIL ID </td><td align="right"><input type="text" name="mail" /></td></tr>
                <tr><td>MESSAGE</td><td align="right"><textarea style="height:100px; width:300px" name="desc"></textarea></td></tr>
...
<?php 
                    ...
                    $note=mysql_query("SELECT * FROM notices WHERE designation LIKE '%Secretary' ORDER BY expiry DESC");
...
<table width="700px" height="400px" style="position:relative; top:50px; left:15%;">
            <tr><td ><span style = "color: #222;font-size: 22px;font-weight: 400;"><b>Faculty Incharge</span></td><td align="right">Dr.YOGESH SHARMA</td></tr>
            <tr><td  > <span style = "color: #222;font-size: 22px;font-weight: 400;">General Secretary</span></td><td align="right">RAJESH RANJAN </td></tr>
            <tr>
            <td > <span style = "color: #222;font-size: 22px;font-weight: 400;">Web Designing Club</span></td><td align="right">A.HARI SAI SANDEEP </td></tr><tr>
            <td > <span style = "color: #222;font-size: 22px;font-weight: 400;">Fine Arts Club</span></td><td align="right">KUMAR CHITRESH </td>
            </tr>
            <tr>
            <td > <span style = "color: #222;font-size: 22px;font-weight: 400;">Photography Club</span></td><td align="right">RAJAS SHAH</td></tr><tr>
            <td > <span style = "color: #222;font-size: 22px;font-weight: 400;">Electronics Club</span></td><td align="right">K.SHIVA TEJA </td>
            </tr>
            <tr>
            <td > <span style = "color: #222;font-size: 22px;font-weight: 400;">Literary Club</span></td><td align="right">G.D.V.NARENDRA</td></tr><tr>
            <td > <span style = "color: #222;font-size: 22px;font-weight: 400;">Modelling Club</span></td><td align="right">M.S.Prabhat Reddy </td>
            </tr>
            </table>
</div>
...
<?php 
                    ...
                    $note=mysql_query("SELECT * FROM notices WHERE designation LIKE '%Secretary' ORDER BY expiry DESCs");
                        while($club=mysql_fetch_array($note))
                        {    
                        $dat=date('20y-m-d H:i:s');
                        $expire=$club['expiry'];
