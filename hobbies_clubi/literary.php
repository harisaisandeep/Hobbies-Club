...
<body>
    <div id="heads"><img src="images/hc1.png" style="position :absolute; top:50px;left:34%;"/>
        ...
        <ul class="nav"><li ><a  href="index.php" id="home" class="anchorLink">Hobbies club</a></li><li><a id="webd" class="anchorLink" href="webd.php">Web D</a></li>
            ...
            <li class = "active"><a id="team" href="literary.php" class="anchorLink">Literary</a></li>
...
<p style="margin-left:10px;color: #222;font-size: 26px;font-weight: 400;">About Literary Club</p><hr class ="line"><p class="para">
The literary section or as it is popularly called 'LitSec' is the primary associate in the campus for conducting<br/> all literary events. The literary section, which has a total membership of over 50 people, conducts a plethora <br/>of events like quizzes, debates and word games. The Literary Section conducts a total of around 20 events <br/> throughout the calender year. Unlike other sections the events organised by the Literary Section are open <br/>to all the students on the campus.
            
           <br/> LitSec is not just a group, it's a state of mind.
</p>
...
<p class ="para">Secretary : G.D.V Narendra </p>
...
<?php 
                    ...
                    $note=mysql_query("SELECT * FROM notices WHERE designation ='Literary Club Secretary' ORDER BY expiry DESC");
