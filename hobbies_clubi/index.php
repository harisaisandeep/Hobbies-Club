...
<body>
    <div id="heads"><img src="images/hc1.png" style="position :absolute; top:50px;left:34%;"/>
        ...
        <div>
        <ul class="nav">
            <li class = "active"><a  href="#" id="home" class="anchorLink">Hobbies club</a></li>
...
<p style="margin-left:10px;color: #222;font-size: 26px;font-weight: 400;">About Hobbies Club</p><hr class ="line"><p class="para">The Hobbies Club at the IIT Roorkee,Saharanpur Campus, is the only one of its kind amongst all the IITs.<br/> It aims at facilitating activities like Photography, Web Designing,Modelling etc. which are normally beyond <br/>the reach of any student. The hobbies club council 
    is headed by a Chief Advisor, who is well supported by <br/> two Deputy Chief Advisors (for administration and finance) and a
     council secretary (student representative).<br/>The personnel consist of a Staff Advisor supported by a Secretary,
     who is selected from amongst the members.<br/>This Administrative Hierarchy ensures active student participation as well as the smooth running of the Hobbies Club.</p>
...
<p class ="para">General Secretary : Rajesh Ranjan  </p>
